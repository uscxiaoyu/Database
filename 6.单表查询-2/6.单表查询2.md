...
#### 示例11：根据product表计算不同SubSort_ID的商品单价平均值，列出前10条记录。
...
#### 示例：查询各子类对应的product_name，用逗号连接起来
...
#### 示例16: 查询Product表中的Product_ID，Product_Name，Sort_ID 和SubSort_ID， 把Sort_ID 和SubSort_ID 用“-”连接起来
...
#### 示例17: 查询product表中的Product_ID, Product_Name和Product_Date字段值，如果Product_Date字段的月份大于6则返回下半年，否则返回上半年。
