...
>- `int(11)`指的是字符显示宽度最小宽度为`11`，可以结合`usigned zerofill`一起使用。在`MySQL Server 8.0`以上版本会有警告`[HY000][1681] Integer display width is deprecated and will be removed in a future release.`
```mysql {.line-numbers}
